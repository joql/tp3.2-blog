...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '豫ICP备911号-3',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  '911@911.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'Joql博客',             //网站名：
    'WEB_KEYWORDS'              =>  'Joql博客',         //网站关键字
    'WEB_DESCRIPTION'           =>  'Joql博客',      //网站描述
    'AUTHOR'                    =>  'Joql博客',               //默认作者
    'COPYRIGHT_WORD'            =>  'Joql博客',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'Joql博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'kylinqi.cn',      //文字水印内容
...
//*************************************第三方登录****************************************
    'QQ_APP_ID'                 =>  '1106506192',            // QQ登录APP D
    'QQ_APP_KEY'                =>  'pt5d97YZBUK22qwJ',           // QQ登录APP KEY
